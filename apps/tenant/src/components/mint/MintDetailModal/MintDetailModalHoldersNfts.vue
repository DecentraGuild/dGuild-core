<template>
  <section class="mint-modal__section mint-modal__section--bordered">
    <div class="mint-modal__section-header">
      <h4 class="mint-modal__section-title">Holders & NFTs</h4>
      <div class="mint-modal__view-toggle">
        <button
          type="button"
    ...
    <div v-else-if="!combinedHolders.length" class="mint-modal__empty">
      No holders or member NFTs yet. Add the collection in Address Book and enable Holders tracking.
    </div>
